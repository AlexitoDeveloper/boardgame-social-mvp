...
- [ ] **[LEGAL] Atribución Legal de Datos BGG:** Inclusión de un texto discreto ("Datos proporcionados por BoardGameGeek") en el _footer_, perfil o vista de juego para cumplir estrictamente con los Términos de Servicio de la API.
...
- [ ] **[GRATIS] Ficha de Juego "Viva" (Detalles + Estadísticas en tiempo real)**
- [ ] **[GRATIS] Acciones Rápidas desde la Ficha (Botón "Organizar Partida")**
