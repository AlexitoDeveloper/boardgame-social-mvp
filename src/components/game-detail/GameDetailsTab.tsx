...
export function GameDetailsTab({ game }: GameDetailsTabProps) {
  ...
  if (complexity > 0) {
    if (complexity <= 2.2) {
      ...
      complexityBarColor = 'bg-[#D97706]'
    } else {
      complexityBarColor = 'bg-[#C51F5D]'
    }
  }
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <Card variant="glass" className="p-5 flex flex-col justify-between relative overflow-hidden h-36">
          ...
          <div className="space-y-1">
            ...
            <h3 className="text-3xl font-black font-mono-tabular tracking-tight text-foreground">
        ...
        <Card variant="glass" className="p-5 flex flex-col justify-between relative overflow-hidden h-36">
          ...
          <div className="space-y-1">
            ...
            <div className="flex items-baseline gap-1">
              <h3 className="text-3xl font-black font-mono-tabular tracking-tight text-foreground">{avgRating}</h3>
              <span className="text-xs text-muted-foreground font-semibold">/10</span>
            </div>
          </div>
          <p className="text-xs text-muted-foreground leading-normal">
            {t('gameDetail.geekRating')}: <span className="font-bold font-mono-tabular text-foreground/80">{geekRating}</span>
          </p>
        </Card>
