...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    ref={ref}
    className={cn(
      "fixed inset-0 z-50 bg-black/60 backdrop-blur-xs data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 duration-280 ease-drawer data-[state=closed]:duration-180",
      className
    )}
    {...props}
  />
...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-card/95 dark:bg-[#121829]/95 backdrop-blur-2xl p-6 shadow-2xl data-[state=open]:animate-in data-[state=closed]:animate-out duration-280 ease-drawer data-[state=closed]:duration-180 border-border/40",
  {
    variants: {
      side: {
