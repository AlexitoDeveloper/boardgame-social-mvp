  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3 py-2 border-y border-border max-w-xl mx-auto md:mx-0">
      <div className="flex items-center justify-center md:justify-start gap-2 text-xs font-semibold text-foreground/80">
        <Star className="w-4 h-4 text-amber-500 fill-amber-500 shrink-0" strokeWidth={2} aria-hidden="true" />
      ...
      <div className="flex items-center justify-center md:justify-start gap-2 text-xs font-semibold text-foreground/80">
        <Hourglass className="w-4 h-4 text-teal-500 shrink-0" strokeWidth={2} aria-hidden="true" />
        <div className="flex flex-col">
      ...
      <div className="flex items-center justify-center md:justify-start gap-2 text-xs font-semibold text-foreground/80">
        <Brain className="w-4 h-4 text-purple-500 shrink-0" strokeWidth={2} aria-hidden="true" />
        <div className="flex flex-col">
