...
import { PlayGroupLounges } from '../components/play/PlayGroupLounges'
...
export function PlayPage() {
  ...
  const hasActiveFilters = engine.selectedPlayers !== null || engine.selectedDuration !== 'any' || engine.onlyUnplayed
    ...
    <section className="space-y-8 max-w-4xl mx-auto pb-20 animate-in fade-in duration-300">
      ...
      <div className="rounded-[28px] glass-panel border border-border/40 p-6 sm:p-8 relative overflow-hidden shadow-xl space-y-6">
        ...
        <div className="space-y-1 relative z-10">
          ...
          <h2 className="text-xl sm:text-2xl font-black tracking-tight text-foreground font-display">{t('play.decisionTitle')}</h2>
      ...
      <PlayActiveMeetups />
      <PlayGroupLounges groups={groups} />
      ...
      <ExpressVotingModal
        ...
        roomId={engine.selectedGroupId !== 'personal' ? `group-${engine.selectedGroupId}` : 'general'}
        onGameSelected={(game) => {
